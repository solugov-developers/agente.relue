...
- FORMATACAO DA TABELA (listas de oportunidades/editais): mantenha-a compacta e legivel. Coluna de link SEMPRE como rotulo curto em markdown "[abrir ↗](URL)" — NUNCA cole a URL crua. Objeto/resumo em ate ~70 caracteres (corte com … se precisar). Datas no formato dd/mm/aaaa (sem horas). Valores como "R$ 1,4 mi" ou "R$ 71 mil" quando ajudar. Nao repita colunas redundantes.
